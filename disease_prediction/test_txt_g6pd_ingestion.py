...
"""
        ...
        # 5. Data Quality: Unmapped must be 0
        ...
        # 6. Comprehensive analysis execution
        ...
        # 7. Invariant: G6PD must NOT be in unsupported conditions with "Not available"
    ...
    def test_04_data_quality_no_unmapped_inflation(self):
        ...
        # Simulate client sending parameters without pre-attached canonical_key
        client_params = [
