...
def test_persistence_flow():
    ...
    # 2. Test 1: Create Patient PERSIST-001 via API
    pat1_payload = {
    ...
    # 3. Create Report for PERSIST-001 via AI Health Report Analyzer
    analyzer_payload_1 = {
        "parameters": [
    ...
    # 4. Test 2: Create Patient PERSIST-002 directly through AI Health Report Analyzer (auto-registration test)
    analyzer_payload_2 = {
        "parameters": [
    ...
    # 5. SIMULATE BROWSER REFRESH — Verify Database as Source of Truth
    print("\n[STEP 5] Simulating Full Page Refresh / Backend Querying...")
    
    # 5.1 Query Public Directory
    ...
    # 5.2 Query Admin Patient Directory
    ...
    # 5.3 Query Admin Reports Directory
    ...
    # 6. Patient Portal Authentication & Data Isolation Test
    print("\n[STEP 6] Testing Patient Portal Logins & Isolation...")
    # Login as PERSIST-001
    ...
    # Login as PERSIST-002 (Generated PIN)
    ...
    # 7. Direct SQLite Database File Inspection
