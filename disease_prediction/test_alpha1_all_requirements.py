...
def test_a_alpha1_pdf():
    ...
    # 1. Simulate PDF Text containing Alpha-1 Antitrypsin
    raw_pdf_text = """
    ...
    # Evaluate with Rare Disease Engine
    ...
    # Verify candidate condition details
...
def test_d_missing_aat_with_isolated_liver_abnormalities():
    ...
    # Report has high ALT and AST but NO Alpha-1 Antitrypsin test was ordered/performed
    raw_liver_text = """
    ...
    # Ensure Alpha-1 Antitrypsin Deficiency is NOT flagged as HIGH or top condition
