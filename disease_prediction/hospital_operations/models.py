...
class DataSourceStats(BaseModel):
    ...
    processing_status: str  # e.g., 'Processed', 'Ready'
    last_processed: str
...
class NormalizedHISRecord(BaseModel):
    ...
    numeric_id: int
    admission_datetime: str  # YYYY-MM-DD HH:MM:SS
    discharge_datetime: Optional[str] = None  # YYYY-MM-DD HH:MM:SS
    is_active: bool  # True if discharge_datetime is None
    raw_ward: str
    canonical_ward: str
...
class NormalizedLabRecord(BaseModel):
    ...
    numeric_id: int
    test_name: str
    ordered_at: str  # YYYY-MM-DD HH:MM:SS
    collected_at: str  # YYYY-MM-DD HH:MM:SS
    resulted_at: Optional[str] = None  # YYYY-MM-DD HH:MM:SS
    status: str  # 'Completed', 'Pending'
    raw_priority: str
    canonical_priority: str  # 'STAT', 'URGENT', 'ROUTINE'
    department: str
    ...
    delay_severity: Optional[str] = None  # 'Critical', 'High', 'Moderate', None
    is_outpatient: bool = False  # True for 7xxx IDs not found in HIS admissions


class NormalizedBedRecord(BaseModel):
    row_index: int
    raw_date: str
    canonical_date: str  # YYYY-MM-DD
    raw_ward: str
    canonical_ward: str
    total_beds: int
    occupied: int
...
class MatchedPatientRecord(BaseModel):
    canonical_patient_id: str
    numeric_id: int
    match_status: str  # 'Matched', 'Outpatient_Lab_Only', 'Inpatient_No_Lab'
...
class ConflictRecord(BaseModel):
    conflict_id: str
    category: str  # 'BED_VS_HIS_OCCUPANCY', 'DUPLICATE_HIS_RECORD', 'OUTPATIENT_UNMATCHED', 'MISSING_BED_SHEET_DAY', 'MISSING_FIELD'
    source_a: str
    source_b: Optional[str] = None
    record_ref: str  # e.g., 'Ward: ICU | Date: 2026-07-01' or 'Patient: MCH-0001071'
    source_a_value: Any
    source_b_value: Optional[Any] = None
    difference_summary: str
    applied_rule_id: str
    applied_rule_name: str
    resolution_status: str  # 'Resolved', 'Needs_Review'
...
class DataQualityMetrics(BaseModel):
    ...
    rating: str  # 'Excellent', 'Good', 'Requires Attention'
...
class OperationalAlert(BaseModel):
    ...
    title: str
    message: str
    category: str  # 'Capacity', 'Turnaround', 'Data_Discrepancy', 'Missing_Data'
    affected_entity: str
