...
class BedCapacityMetricsCalculator:
    ...
    def calculate_metrics(
        ...
        # 1. Ward-wise aggregations for the latest operational state (July 30, 2026)
        ...
        # 2. Daily longitudinal occupancy trend across all July days (1 to 30)
        daily_trends = []
