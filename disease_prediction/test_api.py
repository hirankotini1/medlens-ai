...
# Add api and training directories to path
...
def test_health():
    ...
    for disease in ["anemia", "dengue", "liver", "thyroid", "malaria"]:
        assert data["models_available"][disease] is True, f"Model {disease} missing"
    print("  [PASSED] GET /health (All 5 models verified available)")
