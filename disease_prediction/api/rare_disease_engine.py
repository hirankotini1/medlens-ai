...
# Modular Rare Disease Knowledge Base Definitions (Extensible Architecture)
RARE_DISEASE_KNOWLEDGE_BASE: List[Dict[str, Any]] = [
    ...
    # -------------------------------------------------------------
    # 2. Hereditary Hemochromatosis (Systemic Iron Overload)
    # -------------------------------------------------------------
    {
        "id": "hemochromatosis",
    ...
    # -------------------------------------------------------------
    # 4. G6PD Deficiency (Erythrocyte Enzymopathy-Specific)
    # -------------------------------------------------------------
    {
        "id": "g6pd_deficiency",
    ...
    # -------------------------------------------------------------
    # 5. Generic Hemolytic Anemia Pattern (Differential Engine)
    # -------------------------------------------------------------
    {
    ...
    # -------------------------------------------------------------
    # 6. Multiple Myeloma Pattern (Monoclonal Gammopathy)
    # -------------------------------------------------------------
    {
        "id": "multiple_myeloma",
    ...
    # -------------------------------------------------------------
    # 7. Thalassemia Trait / Minor Pattern
    # -------------------------------------------------------------
    {
    ...
    # -------------------------------------------------------------
    # 8. Addison Disease (Primary Adrenocortical Insufficiency)
    # -------------------------------------------------------------
    {
        "id": "addison_disease",
    ...
    # -------------------------------------------------------------
    # 9. Cushing Syndrome Pattern (Hypercortisolemia)
    # -------------------------------------------------------------
    {
        "id": "cushing_syndrome",
    ...
    # -------------------------------------------------------------
    # 10. Acute / Cutaneous Porphyria Pattern
    # -------------------------------------------------------------
    {
        "id": "porphyria",
    ...
    # -------------------------------------------------------------
    # 11. Autoimmune Hepatitis Pattern
    # -------------------------------------------------------------
    {
    ...
    # -------------------------------------------------------------
    # 12. Primary Biliary Cholangitis (PBC) Pattern
    # -------------------------------------------------------------
    {
    ...
    # -------------------------------------------------------------
    # 13. Hereditary Spherocytosis / Membrane Hemolytic Pattern
    # -------------------------------------------------------------
    {
    ...
    # -------------------------------------------------------------
    # 14. Thrombotic Microangiopathy Pattern (TTP / HUS / TMA)
    # -------------------------------------------------------------
    {
...
def evaluate_rare_disease_patterns(
    ...
    # Build canonical map with cross-alias bridging
    ...
    for p in parameters:
        ...
        # Invariant: Cross-alias bridging for standard condition markers
    ...
    for profile in RARE_DISEASE_KNOWLEDGE_BASE:
        ...
        # 3. Evaluate Demographic Context
        ...
        # 5. Determine Screening Signal Strength with Strict Clinical Gating
        ...
        # Strict Gating: No rare disease can receive HIGH or MODERATE without disease-specific primary evidence
        ...
        # Calculate genuine evidence concordance score
        ...
        if screening_strength != "NONE" and prim_cnt >= 1:
            ...
            # Build audit of checked evidence for unsupported conditions
            evidence_checked = []
            for pm in profile.get("primary_markers", []):
                k = pm["key"]
                p_obj = param_map.get(k)
            ...
            # Check if any organ-related biomarker was present
            has_any_related = any(
    ...
    # Sort candidate conditions by screening strength (HIGH -> MODERATE -> LOW) and concordance score descending
    ...
    # Aggregate helpful missing diagnostic tests across top conditions
    helpful_missing = []
    seen_tests = set()
    ...
    # If no condition flagged, pull missing tests from relevant unsupported conditions
    ...
    # Check for Generic Hepatocellular Transaminitis Fallback
    # (ALT/AST elevated but no rare disease primary markers matched)
    ...
    return {
        ...
        # Backward compatibility for legacy summary consumers:
