...
def generate_anemia_synthetic(random_state=42):
    ...
    # Define clinical boundaries for clipping
    clinical_bounds = {
        'Age': (1, 110),
        'HGB': (2.0, 25.0),
        'RBC': (1.0, 9.0),
    ...
    for pct in percentages:
        ...
        # Stratified class conditional sampling preserving correlation structure
        ...
        # Ensure no duplicates with train or test
