...
def create_presentation():
    ...
    # Color Palette (Modern Dark Clinical Theme)
    C_BG = RGBColor(11, 15, 25)          # #0B0F19
    C_CARD = RGBColor(17, 24, 39)        # #111827
    C_CARD_BORDER = RGBColor(30, 41, 59) # #1E293B
    C_PRIMARY = RGBColor(99, 102, 241)   # #6366F1
    C_ACCENT = RGBColor(6, 182, 212)     # #06B6D4
    C_TEXT_MAIN = RGBColor(248, 250, 252)# #F8FAFC
    C_TEXT_MUTED = RGBColor(148, 163, 184)# #94A3B8
    C_SUCCESS = RGBColor(16, 185, 129)   # #10B981
    C_WARN = RGBColor(245, 158, 11)      # #F59E0B
    ...
    # -------------------------------------------------------------
    # SLIDE 11: Synthetic Data Experiment
    # -------------------------------------------------------------
