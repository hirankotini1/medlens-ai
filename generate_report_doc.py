...
def create_report():
    ...
    # -------------------------------------------------------------
    # 7. LIST OF FIGURES & 8. LIST OF TABLES
    # -------------------------------------------------------------
    ...
    # -------------------------------------------------------------
    # 12. EXISTING VS PROPOSED SYSTEM
    # -------------------------------------------------------------
    ...
    # -------------------------------------------------------------
    # 13. SYSTEM ARCHITECTURE & 14. REQUIREMENTS
    # -------------------------------------------------------------
    ...
    # -------------------------------------------------------------
    # 16. MACHINE LEARNING METHODOLOGY & MODELS
    # -------------------------------------------------------------
